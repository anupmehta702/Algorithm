		...
		example.check();
		 ...
		 ConcurrentHashMap<String,String> premiumPhone = new ConcurrentHashMap<String,String>();
	        ...
	        while (iterator.hasNext()) {
	            System.out.println("Extracting value -->"+premiumPhone.get(iterator.next()));
	            premiumPhone.put("Sony", "Xperia");// This would throw exception for HashMap - ConcurrentModificationException
	        }
